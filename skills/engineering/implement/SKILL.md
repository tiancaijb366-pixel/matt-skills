...
2. /ponytail-review — Subagent reviewer: check for over-engineering. Fix findings.

3. /code-review — Subagent reviewer: two parallel sub-agents (Standards + Spec). Fix findings.
